...
async function fetchWeatherPrayer(city) {
    try {
        ...
        if (city.includes(" ")) {
            ...
            document.body.style.backgroundImage = `url(https://source.unsplash.com/1600x900/?${HttpCopmatCityName}*)`;
        } else {
...
function reset() {
    document.body.style.backgroundImage = "url(images/bg-img.jpg)";
    citySearchEl.value = '';
